...
w('app/explainability/shap_explainer.py', """import logging, numpy as np
...
w('app/explainability/feature_importance.py', """import logging, numpy as np
logger = logging.getLogger(__name__)
...
print('Explainability modules done')